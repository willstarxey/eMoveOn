...
<div class="row form-group col-md-12">
    ...
    <input id="user_id" name="user_id" type="text" class="form-control col-md-2" style="visibility: hidden;" value="{{$user}}">
    <input name="costo" id="costo" class="form-control col-md-2" type="text" style="visibility: hidden;" value="">
</div>